...
def trigger_control() -> Response:
	...
	function_arguments:dict = data.get('function_arguments', {})
	...
	for control in current_screen.controls:
		if control.id == control_id:
			if control.action:
				control_arg_name = control.get_action_control_arg(list(function_arguments.keys()))
				if control_arg_name:
					function_arguments[control_arg_name] = control
